...
4. Ejecuta el comando npm install react-router-dom para instalar las dependencias de rutas.
5. Ejecuta el comando npm install firebase para instalar las dependencias de la base de datos.
6. Ejecuta el comando npm run dev para iniciar la aplicación.
7. Abre tu navegador y navega a http://localhost:5173 para ver la aplicación en acción.
